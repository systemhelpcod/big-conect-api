...
exports.encodeBinaryNodeInner = exports.encodeBinaryNode = void 0;
const constants = __importStar(require("./constants"));
const jid_utils_1 = require("./jid-utils");
const encodeBinaryNode = (node, opts = constants, buffer = [0]) => {
    const encoded = (0, exports.encodeBinaryNodeInner)(node, opts, buffer);
    return Buffer.from(encoded);
};
exports.encodeBinaryNode = encodeBinaryNode;
const encodeBinaryNodeInner = ({ tag, attrs, content }, opts = constants, buffer = [0]) => {
    ...
    if (typeof content === "string") {
        ...
        for (const item of content) {
            (0, exports.encodeBinaryNodeInner)(item, opts, buffer);
        }
    }
...
exports.encodeBinaryNodeInner = encodeBinaryNodeInner;
