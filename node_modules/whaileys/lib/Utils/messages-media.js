...
async function getAudioWaveform(buffer, logger) {
    ...
    let decoder;
    try {
        const { OggOpusDecoder } = (await Promise.resolve().then(() => __importStar(require("ogg-opus-decoder"))));
        let oggData;
        if (Buffer.isBuffer(buffer)) {
            oggData = new Uint8Array(buffer);
        }
        else if (typeof buffer === "string") {
            const fileData = await fs_1.promises.readFile(buffer);
        ...
        if (!(channelData === null || channelData === void 0 ? void 0 : channelData.length) || !((_a = channelData[0]) === null || _a === void 0 ? void 0 : _a.length)) {
            return undefined;
        }
        const samples = 64;
        ...
        decoder.free();
        return new Uint8Array(peaks.map(peak => {
        ...
        logger === null || logger === void 0 ? void 0 : logger.debug({ err: error }, "failed to generate waveform");
        return undefined;
    }
    finally {
        try {
            decoder === null || decoder === void 0 ? void 0 : decoder.free();
        }
        catch (freeError) {
            (_b = logger === null || logger === void 0 ? void 0 : logger.trace) === null || _b === void 0 ? void 0 : _b.call(logger, { err: freeError }, "failed to free ogg decoder");
        }
    }
}
