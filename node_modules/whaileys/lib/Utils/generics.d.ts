...
export declare const generateMessageIDV2: (userId?: string | undefined) => string;
...
declare type FetchWaWebVersionResult = {
    version: WAVersion;
    isLatest: boolean;
    error?: unknown;
};
 ...
 * Use to ensure your WA connection is always on the latest version
 */
export declare const fetchLatestWaWebVersion: (options?: AxiosRequestConfig) => Promise<FetchWaWebVersionResult>;
